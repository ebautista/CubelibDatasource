...
Module MTrace
    ...
    Public Sub AddToTrace(ByVal Message As String, Optional ByVal DebugOnly As Boolean = False)
        Dim fileReName As String = objProp.getDatabasePath & "\DatasourceTracefile_" & Format(Now, "yyyyMMdd_hhmmss") & ".log"
        Dim fileName As String = objProp.getDatabasePath & "\DatasourceTracefile.log"

...
Module MTrace
    ...
    Public Sub AddToTrace(ByVal Message As String, Optional ByVal DebugOnly As Boolean = False)
        Dim fileReName As String = G_ObjProp.getDatabasePath & "\DatasourceTracefile_" & Format(Now, "yyyyMMdd_hhmmss") & ".log"
        Dim fileName As String = G_ObjProp.getDatabasePath & "\DatasourceTracefile.log"

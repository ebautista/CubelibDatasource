...
Module MSadbel
    ...
    Public Function FindAndUpdateRowOther(ByRef RecordsetToUpdate As ADODB.Recordset,
        ...
        dataset = getTableSchema(strTableName, DBInstanceType.DATABASE_OTHER, "", OtherDatabaseName)
        ...
        command = getConnectionObjectsNonQuery(fullUpdateClause, DBInstanceType.DATABASE_OTHER, "", OtherDatabaseName)
    ...
    Public Function InsertRowOther(ByRef ADORecordsetToInsert As ADODB.Recordset, _
        ...
        Try
            ...
            command = getConnectionObjectsNonQuery(fullInsertClause, DBInstanceType.DATABASE_OTHER, "", OtherDatabaseName)
